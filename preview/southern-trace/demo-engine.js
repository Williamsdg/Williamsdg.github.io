...
(function() {
  ...
  function renderResidentRow(r) {
    ...
    var balanceColor = r.balance > 0 ? 'var(--danger)' : 'var(--moss)';
  ...
  function renderHealthCard(c) {
    ...
    return '<div class="health-card" data-community="' + c.id + '">' +
      ...
      '<div class="health-score">' +
        '<span class="health-grade" style="color:' + (barClass === 'green' ? 'var(--moss)' : barClass === 'yellow' ? 'var(--warning)' : 'var(--danger)') + ';">' + c.healthGrade + '</span>' +
  ...
  function renderEventItem(evt) {
    ...
    var typeTextColors = {
      ...
      'community': 'var(--moss)',
      'deadline': 'var(--danger)',
      'reservation': 'var(--brass-dark)',
      'hearing': 'var(--danger)',
      'maintenance': 'var(--pine)'
    };
