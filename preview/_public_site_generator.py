...
SITES = [
    ...
    {
        "slug": "tourism",
        "site_slug": "sandbar-coastal-site",
        "brand": "Sandbar Coastal Co.",
        "brand_em": "Coastal Co.",
        "brand_short": "Sandbar",
        "tagline": "Sunset sails, dolphin tours, kayak runs, and wild-horse beach trips on the Outer Banks.",
        "eyebrow": "Outer Banks · Boat Tours & Adventures",
        "primary": "#0e7490",
        "primary_dark": "#155e75",
        "favicon_letter": "S",
        "phone": "(252) 555-1100",
        "email": "book@sandbarcoastal.com",
        "address": "108 Old Oregon Inlet Rd · Nags Head, NC 27959",
        "hours": "Daily 7a–9p · Apr–Oct",
        "founded": 2014,
        "founder_name": "Captain Reed Maddox",
        "founder_title": "USCG Master 100T · Owner",
        "founder_short": "Captain Reed",
        "founder_quote": "The water has a way of slowing people down. The job is just to get them on it, and let it do the rest.",
        "philosophy": "Boats, boards, and a piece of <em>the right water</em> at the right hour.",
        ...
        "story_img": "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=900&q=85",
        "story_alt": "Boat captain at the helm",
        "services": [
            ...
            {"name": "Dolphin Watch", "desc": "90-minute cruise through Roanoke Sound. We see them on 9 of 10 trips. Calm-water boat, kid-friendly.", "img": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=900&q=85"},
            ...
            {"name": "Wild Horse Beach Tour", "desc": "Four-wheel-drive trip up to Carova to find the Banker horses. 2.5 hours, small groups, naturalist on board.", "img": "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=900&q=85"},
            {"name": "Surf Lesson for Beginners", "desc": "90-minute lesson, soft-top boards included. Most students stand up by the second wave.", "img": "https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=900&q=85"},
            {"name": "Lighthouse Climb", "desc": "Self-guided history walk and the Bodie Island lighthouse climb. Easy add-on to a beach day.", "img": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=900&q=85"},
        ],
        "gallery": [
            ...
            "https://images.unsplash.com/photo-1545579133-99bb5ab189bd?w=600&q=85",
            "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=600&q=85",
            "https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=600&q=85",
        ],
        "press": [
            {"q": "Captain Reed knew exactly when the light would turn. Couldn't have asked for a better night.", "by": "Karen W. · Charlotte"},
            {"q": "Saw a stallion within twenty minutes. Mari was a real naturalist — every question had a real answer.", "by": "Paolo D. · Richmond"},
            {"q": "Tess was patient with my kids. Stood up on my second try. We're already planning to come back next summer.", "by": "Janelle T. · Raleigh"},
        ],
        "cta_label": "Book a Tour",
        "cta_sub": "Small groups · USCG-licensed · Apr–Oct season · Book direct or through your hotel",
        "footer_lines": ["Outer Banks, North Carolina", "USCG Master 100T · Insured", "Apr–Oct · 6 experiences"],
    },
    {
        "slug": "tourism",
        "site_slug": "summit-stone-site",
        "brand": "Summit & Stone Outfitters",
        "brand_em": "& Stone",
        "brand_short": "Summit",
        "tagline": "Guided hikes, mountain bike trails, and waterfall walks through the Smokies.",
        "eyebrow": "Smoky Mountains · Adventure Outfitter",
        "primary": "#166534",
        "primary_dark": "#14532d",
        "favicon_letter": "M",
        "phone": "(865) 555-2200",
        "email": "trips@summitstone.com",
        "address": "412 Parkway · Gatlinburg, TN 37738",
        "hours": "Daily 6a–8p · Year-round",
        "founded": 2009,
        "founder_name": "Wes Cardwell",
        "founder_title": "WFR · AMGA-trained · Owner",
        "founder_short": "Wes Cardwell",
        "founder_quote": "The mountain is the same mountain whether you're moving fast or slow. The guide's job is to figure out which one you came for.",
        "philosophy": "Hike it. Bike it. Wade it. <em>Just don't rush it.</em>",
        "story_p1": "Summit & Stone has been guiding trips through the Smokies since 2009. We started with sunrise hikes and a single set of trekking poles. Today we run hikes, mountain bike rides, whitewater rafting on the Pigeon, backcountry overnights, and photo walks for guests who want a slower pace.",
        "story_p2": "Our guides are wilderness-medicine certified and most have been working these ridges for ten-plus years. They know which switchback turns the light at six in the evening and which side of the creek hides the salamanders. That's not on the map.",
        "story_p3": "We cap groups small on purpose. Eight on a hike. Six on a raft. Eight on a bike ride. You shouldn't have to elbow somebody to get a clear view of an overlook you drove eight hours to see.",
        "hero_img": "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1800&q=85",
        "hero_alt": "Smoky mountain ridge at sunrise with morning fog",
        "story_img": "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=900&q=85",
        "story_alt": "Mountain guide on a trail",
        "services": [
            {"name": "Sunrise Summit Hike", "desc": "Four-hour hike to a high overlook for golden hour. We're at the trailhead by 5am with thermos coffee.", "img": "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=900&q=85"},
            {"name": "Waterfall Trail Tour", "desc": "Three-hour walk to two named falls and a swimming hole. Easy pace, family-friendly, naturalist guide.", "img": "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=900&q=85"},
            {"name": "Mountain Bike · Intermediate", "desc": "Two-and-a-half hour ride on flowy singletrack. Demo-quality trail bikes provided. Helmet on every rider.", "img": "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=900&q=85"},
            {"name": "Whitewater Raft (Pigeon River)", "desc": "Class II–III on the Upper Pigeon. Three-and-a-half hours, six per boat, certified swiftwater guide on every trip.", "img": "https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=900&q=85"},
            {"name": "Backcountry Overnight", "desc": "Two-day, one-night guided backpacking. We cover gear, permits, dinner, and breakfast on the trail.", "img": "https://images.unsplash.com/photo-1455156218388-5e61b526818b?w=900&q=85"},
            {"name": "Wildlife & Photo Walk", "desc": "Two-hour slow walk for photographers and birdwatchers. Bring your camera; we bring the patience.", "img": "https://images.unsplash.com/photo-1426604966848-d7adac402bff?w=900&q=85"},
        ],
        "gallery": [
            ...
            "https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=600&q=85",
            "https://images.unsplash.com/photo-1455156218388-5e61b526818b?w=600&q=85",
        ],
        "press": [
            {"q": "Wes paced it perfectly. Watched the fog burn off the valley below us at 6:42am. Worth every penny.", "by": "B. Ortiz · Asheville"},
            {"q": "Lila was hilarious AND got us through Class III without a swimmer. Both of those things matter.", "by": "The Sloans · Cincinnati"},
            {"q": "Tariq pointed out three salamanders the kids would have walked right past. The whole walk turned into a natural history lesson.", "by": "The Forrests · Nashville"},
        ],
        "cta_label": "Book a Trip",
        "cta_sub": "Small groups · WFR-certified guides · Year-round · Permitted in GSMNP",
        "footer_lines": ["Gatlinburg, Tennessee", "WFR · AMGA-trained · Insured", "Permitted operator · GSMNP"],
    },
    {
        "slug": "tourism",
        "site_slug": "northpoint-alpine-site",
        "brand": "Northpoint Alpine Resort",
        "brand_em": "Alpine",
        "brand_short": "Northpoint",
        "tagline": "Lift tickets, ski school, snowboard rentals, and a tubing hill for the ones who don't want to lesson up.",
        "eyebrow": "Stowe, Vermont · Mountain Resort",
        "primary": "#1e3a8a",
        "primary_dark": "#1e40af",
        "favicon_letter": "N",
        "phone": "(802) 555-3300",
        "email": "snow@northpointalpine.com",
        "address": "1840 Mountain Rd · Stowe, VT 05672",
        "hours": "Daily 8a–9p · Late Nov–Apr · Conditions permitting",
        "founded": 1978,
        "founder_name": "Hannelore Brandt",
        "founder_title": "PSIA L3 · GM",
        "founder_short": "Hannelore Brandt",
        "founder_quote": "Cold weather, sharp edges, soft snow. Get those three right and the rest of the day takes care of itself.",
        "philosophy": "Sharp edges. <em>Soft snow.</em> Open lifts.",
        "story_p1": "Northpoint Alpine has been cutting its own trails on the Stowe ridgeline since 1978. We're not the biggest mountain in Vermont — and that's the point. Twelve named runs. Three lifts. A tubing hill the kids actually like more than skiing. A lodge that pours real coffee.",
        ...
        "story_img": "https://images.unsplash.com/photo-1549944850-84e00be4203b?w=900&q=85",
        "story_alt": "Skier on a fresh corduroy trail",
        "services": [
            {"name": "Day Lift Ticket", "desc": "All-day access to Eagle Express, Summit Six, and the Beginner Carpet. Adult and child rates. Save online.", "img": "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=900&q=85"},
            {"name": "Group Ski Lesson", "desc": "Two-hour group lesson, ages 7+. Eight max per class. Equipment rental can be bundled.", "img": "https://images.unsplash.com/photo-1486946255434-2466348c2166?w=900&q=85"},
            {"name": "Private Snowboard Lesson", "desc": "90-minute private with a PSIA L2+ instructor. Adaptive snowboard instructor available.", "img": "https://images.unsplash.com/photo-1551524559-8af4e6624178?w=900&q=85"},
            {"name": "Snow Tubing Session", "desc": "Two-hour tubing hill access. Tubes provided. The most efficient way ever invented to make a kid sleep on the drive home.", "img": "https://images.unsplash.com/photo-1578772538130-49e8a6dd34a4?w=900&q=85"},
            {"name": "Backcountry Snowshoe", "desc": "Three-hour guided snowshoe outside the resort boundary. Avalanche-aware guide, all gear provided.", "img": "https://images.unsplash.com/photo-1545048702-79362596cdc9?w=900&q=85"},
            {"name": "Equipment Rentals", "desc": "Skis, snowboards, helmets, poles. Reservation-priority lane for online bookings.", "img": "https://images.unsplash.com/photo-1486946255434-2466348c2166?w=900&q=85"},
        ],
        "gallery": [
            "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=1200&q=85",
            "https://images.unsplash.com/photo-1486946255434-2466348c2166?w=600&q=85",
            "https://images.unsplash.com/photo-1549944850-84e00be4203b?w=600&q=85",
            "https://images.unsplash.com/photo-1551524559-8af4e6624178?w=600&q=85",
            "https://images.unsplash.com/photo-1578772538130-49e8a6dd34a4?w=600&q=85",
        ],
        "press": [
            {"q": "Hannelore had my 7-year-old skiing parallel by lunch. I cannot believe what these instructors get done in two hours.", "by": "L. Stafford · Burlington"},
            {"q": "Lift lines were short, conditions were perfect, my kids slept on the drive home. That's the trifecta.", "by": "Park Family · Boston"},
            {"q": "Tomás was unbelievably patient with my adaptive needs. Best lesson I've ever had — and I've taken a lot of them.", "by": "C. Mendoza · Montreal"},
        ],
        "cta_label": "Buy Tickets",
        "cta_sub": "Reservations recommended on weekends · Season pass available · PSIA-certified school",
        "footer_lines": ["Stowe, Vermont", "PSIA · AASI · Adaptive certified", "Late November – April · Since 1978"],
    },
]
...
/* HERO */
.hero{{position:relative;min-height:100vh;min-height:100svh;display:flex;align-items:center;justify-content:center;padding:120px 24px 60px;overflow:hidden}}
...
@media(max-width:680px){{
    ...
    .philosophy-quote{{font-size:1.4rem;line-height:1.4}}
    .press{{padding:72px 18px}}
    ...
    .gallery{{grid-template-columns:1fr;margin-top:40px;gap:10px}}
    .gallery .gal:first-child{{grid-column:auto;grid-row:auto}}
    .gallery .gal{{aspect-ratio:4/3}}
    .gallery .gal img{{aspect-ratio:auto}}
    .hero{{padding:96px 18px 56px}}
    .hero-content{{padding:0 4px}}
    .hero .eye{{font-size:.62rem;letter-spacing:3px;margin-bottom:24px;gap:12px}}
    .hero .eye::before,.hero .eye::after{{width:24px}}
    .hero .tagline{{font-size:.95rem;margin-top:22px}}
    .hero-actions{{margin-top:36px;gap:10px}}
    .hero-actions .btn{{padding:13px 24px;font-size:.7rem;letter-spacing:1.5px;width:auto}}
    .scroll-cue{{display:none}}
    .story-content p{{font-size:.94rem;line-height:1.75}}
    .press-card{{padding:30px 22px}}
    .press-card::before{{font-size:4rem;left:18px;top:-10px}}
    .press-q{{font-size:1rem}}
    .contact-info{{margin-top:40px;gap:28px}}
    .sticky-dash{{bottom:14px;right:14px;padding:9px 16px;font-size:.64rem;letter-spacing:1.2px;max-width:calc(100vw - 28px)}}
}}
...
@media(orientation:landscape) and (max-height:520px){{
    ...
    .hero h1{{font-size:clamp(1.8rem, 6vh, 3rem);line-height:1.05}}
    .hero .eye{{margin-bottom:16px}}
    .hero .tagline{{margin-top:14px;font-size:.92rem}}
    .hero-actions{{margin-top:22px}}
    .scroll-cue{{display:none}}
    section{{padding:64px 36px}}
    .philosophy{{padding:56px 32px}}
    .press,.contact{{padding:64px 32px}}
    .story{{grid-template-columns:1fr 1fr;gap:36px}}
