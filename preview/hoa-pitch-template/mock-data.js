...
(function() {
  ...
  var residents = [
    ...
    { id: 'R-002', firstName: 'Rachel', lastName: 'Foster', initials: 'RF', email: 'rachel.foster@email.com', phone: '(205) 555-0421', address: '421 Overton Way', community: 'briarwood-oaks', communityName: 'Briarwood Oaks', status: 'current', balance: 0, lastPayment: daysAgo(5), moveInDate: '2020-03-10', avatarColor: 'teal' },
    { id: 'R-003', firstName: 'James', lastName: 'Cooper', initials: 'JC', email: 'james.cooper@email.com', phone: '(205) 555-0387', address: '387 Innisfree Cir', community: 'the-vineyards', communityName: 'The Vineyards', status: 'past-due', balance: 550.00, lastPayment: daysAgo(45), moveInDate: '2017-11-22', avatarColor: 'gold' },
    { id: 'R-004', firstName: 'Amanda', lastName: 'Price', initials: 'AP', email: 'amanda.price@email.com', phone: '(205) 555-0156', address: '156 Summit Cove Ln', community: 'the-meadows', communityName: 'The Meadows', status: 'current', balance: 0, lastPayment: daysAgo(8), moveInDate: '2021-08-01', avatarColor: 'teal' },
    { id: 'R-005', firstName: 'Nathan', lastName: 'Brooks', initials: 'NB', email: 'nathan.brooks@email.com', phone: '(205) 555-0293', address: '293 Park Overlook Dr', community: 'magnolia-grove', communityName: 'Magnolia Grove', status: 'delinquent', balance: 825.00, lastPayment: daysAgo(95), moveInDate: '2018-04-15', avatarColor: 'navy' },
    { id: 'R-006', firstName: 'Jennifer', lastName: 'Murphy', initials: 'JM', email: 'jennifer.murphy@email.com', phone: '(205) 555-0744', address: '744 Oak Grove Ct', community: 'pinehurst-reserve', communityName: 'Pinehurst Reserve', status: 'current', balance: 0, lastPayment: daysAgo(3), moveInDate: '2016-09-30', avatarColor: 'gold' },
    { id: 'R-007', firstName: 'David', lastName: 'Chen', initials: 'DC', email: 'david.chen@email.com', phone: '(205) 555-0518', address: '518 Heatherwood Blvd', community: 'willowbrook', communityName: 'Willowbrook', status: 'current', balance: 250.00, lastPayment: daysAgo(20), moveInDate: '2019-01-12', avatarColor: 'teal' },
    { id: 'R-008', firstName: 'Sarah', lastName: 'Williams', initials: 'SW', email: 'sarah.williams@email.com', phone: '(205) 555-0629', address: '629 Highlands Dr', community: 'stonehaven', communityName: 'Stonehaven', status: 'current', balance: 0, lastPayment: daysAgo(7), moveInDate: '2020-11-05', avatarColor: 'navy' },
    { id: 'R-009', firstName: 'Christopher', lastName: 'Taylor', initials: 'CT', email: 'chris.taylor@email.com', phone: '(205) 555-0831', address: '831 Gardens Way', community: 'the-meadows', communityName: 'The Meadows', status: 'past-due', balance: 450.00, lastPayment: daysAgo(62), moveInDate: '2018-07-20', avatarColor: 'gold' },
    { id: 'R-010', firstName: 'Emily', lastName: 'Johnson', initials: 'EJ', email: 'emily.johnson@email.com', phone: '(205) 555-0275', address: '275 Magnolia Pl', community: 'magnolia-grove', communityName: 'Magnolia Grove', status: 'current', balance: 0, lastPayment: daysAgo(2), moveInDate: '2021-03-18', avatarColor: 'teal' },
    { id: 'R-011', firstName: 'Robert', lastName: 'Martinez', initials: 'RM', email: 'robert.martinez@email.com', phone: '(205) 555-0912', address: '912 The Reserve Rd', community: 'ashbury-hill', communityName: 'Ashbury Hill', status: 'current', balance: 250.00, lastPayment: daysAgo(18), moveInDate: '2017-05-10', avatarColor: 'navy' },
    ...
    { id: 'R-013', firstName: 'Thomas', lastName: 'Wilson', initials: 'TW', email: 'thomas.wilson@email.com', phone: '(205) 555-0188', address: '188 Cahaba Ridge Ct', community: 'stonehaven', communityName: 'Stonehaven', status: 'current', balance: 325.00, lastPayment: daysAgo(14), moveInDate: '2019-09-22', avatarColor: 'teal' },
    { id: 'R-014', firstName: 'Maria', lastName: 'Garcia', initials: 'MG', email: 'maria.garcia@email.com', phone: '(205) 555-0347', address: '347 Cahaba Reserve Way', community: 'ashbury-hill', communityName: 'Ashbury Hill', status: 'current', balance: 0, lastPayment: daysAgo(4), moveInDate: '2020-06-14', avatarColor: 'navy' },
    { id: 'R-015', firstName: 'Daniel', lastName: 'Thompson', initials: 'DT', email: 'daniel.thompson@email.com', phone: '(205) 555-0556', address: '556 Briarwood Village Pkwy', community: 'briarwood-oaks', communityName: 'Briarwood Oaks', status: 'delinquent', balance: 1100.00, lastPayment: daysAgo(120), moveInDate: '2016-02-28', avatarColor: 'gold' },
    { id: 'R-016', firstName: 'Ashley', lastName: 'Brown', initials: 'AB', email: 'ashley.brown@email.com', phone: '(205) 555-0721', address: '721 Bray Ct', community: 'briarwood-oaks', communityName: 'Briarwood Oaks', status: 'current', balance: 0, lastPayment: daysAgo(9), moveInDate: '2022-01-15', avatarColor: 'teal' },
    { id: 'R-017', firstName: 'Kevin', lastName: 'Davis', initials: 'KD', email: 'kevin.davis@email.com', phone: '(205) 555-0894', address: '894 Heatherwood Blvd', community: 'willowbrook', communityName: 'Willowbrook', status: 'current', balance: 250.00, lastPayment: daysAgo(22), moveInDate: '2018-10-05', avatarColor: 'navy' },
    ...
    { id: 'R-019', firstName: 'Andrew', lastName: 'Jackson', initials: 'AJ', email: 'andrew.jackson@email.com', phone: '(205) 555-0467', address: '467 Oak Grove Ct', community: 'pinehurst-reserve', communityName: 'Pinehurst Reserve', status: 'current', balance: 350.00, lastPayment: daysAgo(16), moveInDate: '2017-07-12', avatarColor: 'teal' },
    { id: 'R-020', firstName: 'Stephanie', lastName: 'White', initials: 'SW2', email: 'stephanie.white@email.com', phone: '(205) 555-0683', address: '683 Innisfree Cir', community: 'the-vineyards', communityName: 'The Vineyards', status: 'current', balance: 0, lastPayment: daysAgo(10), moveInDate: '2021-11-30', avatarColor: 'navy' },
    ...
    { id: 'R-022', firstName: 'Nicole', lastName: 'Lewis', initials: 'NL', email: 'nicole.lewis@email.com', phone: '(205) 555-0941', address: '941 Cahaba Ridge Ct', community: 'stonehaven', communityName: 'Stonehaven', status: 'current', balance: 0, lastPayment: daysAgo(3), moveInDate: '2022-05-17', avatarColor: 'teal' },
    { id: 'R-023', firstName: 'Mark', lastName: 'Robinson', initials: 'MR', email: 'mark.robinson@email.com', phone: '(205) 555-0378', address: '378 Cahaba Reserve Way', community: 'ashbury-hill', communityName: 'Ashbury Hill', status: 'current', balance: 250.00, lastPayment: daysAgo(19), moveInDate: '2016-08-25', avatarColor: 'navy' },
    { id: 'R-024', firstName: 'Kimberly', lastName: 'Clark', initials: 'KC', email: 'kim.clark@email.com', phone: '(205) 555-0612', address: '612 Briarwood Village Pkwy', community: 'briarwood-oaks', communityName: 'Briarwood Oaks', status: 'current', balance: 0, lastPayment: daysAgo(7), moveInDate: '2020-09-14', avatarColor: 'gold' },
    { id: 'R-025', firstName: 'Jason', lastName: 'Walker', initials: 'MC'', email: 'jason.walker@email.com', phone: '(205) 555-0845', address: '845 Highlands Dr', community: 'stonehaven', communityName: 'Stonehaven', status: 'current', balance: 300.00, lastPayment: daysAgo(15), moveInDate: '2018-12-01', avatarColor: 'teal' },
    { id: 'R-026', firstName: 'Megan', lastName: 'Hall', initials: 'MH', email: 'megan.hall@email.com', phone: '(205) 555-0176', address: '176 Gardens Way', community: 'the-meadows', communityName: 'The Meadows', status: 'delinquent', balance: 675.00, lastPayment: daysAgo(88), moveInDate: '2017-04-22', avatarColor: 'navy' },
    { id: 'R-027', firstName: 'Ryan', lastName: 'Allen', initials: 'RA', email: 'ryan.allen@email.com', phone: '(205) 555-0534', address: '534 Summit Cove Ln', community: 'the-meadows', communityName: 'The Meadows', status: 'current', balance: 0, lastPayment: daysAgo(6), moveInDate: '2021-06-10', avatarColor: 'gold' },
    { id: 'R-028', firstName: 'Lisa', lastName: 'Young', initials: 'LY', email: 'lisa.young@email.com', phone: '(205) 555-0793', address: '793 Park Overlook Dr', community: 'magnolia-grove', communityName: 'Magnolia Grove', status: 'past-due', balance: 450.00, lastPayment: daysAgo(48), moveInDate: '2019-11-18', avatarColor: 'teal' },
    { id: 'R-029', firstName: 'Timothy', lastName: 'King', initials: 'TK', email: 'timothy.king@email.com', phone: '(205) 555-0367', address: '367 Magnolia Pl', community: 'magnolia-grove', communityName: 'Magnolia Grove', status: 'current', balance: 275.00, lastPayment: daysAgo(13), moveInDate: '2020-02-05', avatarColor: 'navy' },
    { id: 'R-030', firstName: 'Rebecca', lastName: 'Wright', initials: 'RW', email: 'rebecca.wright@email.com', phone: '(205) 555-0629', address: '629 The Reserve Rd', community: 'ashbury-hill', communityName: 'Ashbury Hill', status: 'current', balance: 0, lastPayment: daysAgo(4), moveInDate: '2022-07-20', avatarColor: 'gold' },
    ...
    { id: 'R-032', firstName: 'Angela', lastName: 'Green', initials: 'AG', email: 'angela.green@email.com', phone: '(205) 555-0815', address: '815 Cahaba Ridge Ct', community: 'stonehaven', communityName: 'Stonehaven', status: 'current', balance: 325.00, lastPayment: daysAgo(17), moveInDate: '2019-05-30', avatarColor: 'navy' },
    { id: 'R-033', firstName: 'Eric', lastName: 'Adams', initials: 'EA', email: 'eric.adams@email.com', phone: '(205) 555-0153', address: '153 Cahaba Reserve Way', community: 'ashbury-hill', communityName: 'Ashbury Hill', status: 'current', balance: 0, lastPayment: daysAgo(5), moveInDate: '2021-01-08', avatarColor: 'gold' },
    { id: 'R-034', firstName: 'Heather', lastName: 'Nelson', initials: 'HN', email: 'heather.nelson@email.com', phone: '(205) 555-0696', address: '696 Briarwood Village Pkwy', community: 'briarwood-oaks', communityName: 'Briarwood Oaks', status: 'current', balance: 275.00, lastPayment: daysAgo(11), moveInDate: '2018-06-25', avatarColor: 'teal' },
    { id: 'R-035', firstName: 'Gregory', lastName: 'Carter', initials: 'GC', email: 'gregory.carter@email.com', phone: '(205) 555-0928', address: '928 Bray Ct', community: 'briarwood-oaks', communityName: 'Briarwood Oaks', status: 'current', balance: 0, lastPayment: daysAgo(1), moveInDate: '2023-02-14', avatarColor: 'navy' }
  ];
  ...
  var arcApplications = [
    ...
    { id: 'ARC-2026-030', resident: 'Thomas Wilson', community: 'Stonehaven', address: '188 Cahaba Ridge Ct', type: 'Deck Expansion', description: 'Extend existing deck by 8 feet with composite decking', status: 'approved', submittedDate: daysAgo(12), estimatedCost: 12000, attachments: 4, approvedDate: daysAgo(5) },
    ...
    { id: 'ARC-2026-028', resident: 'Rachel Foster', community: 'Briarwood Oaks', address: '421 Overton Way', type: 'Roof Replacement', description: 'Full roof replacement with architectural shingles, charcoal gray', status: 'under-review', submittedDate: daysAgo(4), estimatedCost: 18500, attachments: 3 },
    { id: 'ARC-2026-027', resident: 'James Cooper', community: 'The Vineyards', address: '387 Innisfree Cir', type: 'Patio Extension', description: 'Flagstone patio, 12x16 feet, with built-in fire pit', status: 'approved-with-conditions', submittedDate: daysAgo(20), estimatedCost: 9200, attachments: 2, approvedDate: daysAgo(10), conditions: 'Fire pit must be gas, not wood-burning. Setback from fence must be 5ft minimum.' },
    { id: 'ARC-2026-026', resident: 'Daniel Thompson', community: 'Briarwood Oaks', address: '556 Briarwood Village Pkwy', type: 'Driveway Repaving', description: 'Full driveway repaving with stamped concrete', status: 'denied', submittedDate: daysAgo(25), estimatedCost: 6800, attachments: 1, deniedDate: daysAgo(18), deniedReason: 'Stamped concrete pattern does not conform to community design guidelines. Resubmit with approved pattern options.' },
    { id: 'ARC-2026-025', resident: 'Emily Johnson', community: 'Magnolia Grove', address: '275 Magnolia Pl', type: 'Landscaping', description: 'Remove two Bradford pear trees, plant 3 Japanese maples', status: 'approved', submittedDate: daysAgo(30), estimatedCost: 3200, attachments: 1, approvedDate: daysAgo(22) },
    { id: 'ARC-2026-024', resident: 'Mark Robinson', community: 'Ashbury Hill', address: '378 Cahaba Reserve Way', type: 'Solar Panels', description: 'Roof-mounted solar panel installation, 24 panels', status: 'under-review', submittedDate: daysAgo(2), estimatedCost: 28000, attachments: 5 }
  ];
  ...
  // ============================================
  var violations = [
    { id: 'VIO-0452', address: '293 Park Overlook Dr', resident: 'Nathan Brooks', community: 'Magnolia Grove', type: 'Yard Maintenance', description: 'Grass exceeding 8-inch maximum height', severity: 'warning', status: 'open', createdDate: daysAgo(2), assignedTo: 'Diana Reed' },
    { id: 'VIO-0451', address: '176 Gardens Way', resident: 'Megan Hall', community: 'The Meadows', type: 'Parking', description: 'Inoperable vehicle parked in driveway for 30+ days', severity: 'notice', status: 'open', createdDate: daysAgo(5), assignedTo: 'Diana Reed' },
    { id: 'VIO-0450', address: '845 Highlands Dr', resident: 'Jason Walker', community: 'Stonehaven', type: 'Exterior Appearance', description: 'Unapproved paint color on front door', severity: 'notice', status: 'hearing-scheduled', createdDate: daysAgo(14), assignedTo: 'Margaret Chen', hearingDate: daysFromNow(5) },
    ...
    { id: 'VIO-0448', address: '683 Innisfree Cir', resident: 'Stephanie White', community: 'The Vineyards', type: 'Trash/Debris', description: 'Trash cans left at curb past 24-hour removal deadline', severity: 'warning', status: 'resolved', createdDate: daysAgo(10), assignedTo: 'Diana Reed', resolvedDate: daysAgo(7) },
    { id: 'VIO-0447', address: '534 Summit Cove Ln', resident: 'Ryan Allen', community: 'The Meadows', type: 'Parking', description: 'Commercial vehicle parked overnight in residential area', severity: 'notice', status: 'open', createdDate: daysAgo(3), assignedTo: 'Diana Reed' },
    { id: 'VIO-0446', address: '941 Cahaba Ridge Ct', resident: 'Nicole Lewis', community: 'Stonehaven', type: 'Noise', description: 'Repeated noise complaints from neighbors regarding late-night construction', severity: 'warning', status: 'resolved', createdDate: daysAgo(20), assignedTo: 'Margaret Chen', resolvedDate: daysAgo(12) },
    { id: 'VIO-0445', address: '387 Innisfree Cir', resident: 'James Cooper', community: 'The Vineyards', type: 'Unapproved Modification', description: 'Storage shed installed without ARC approval', severity: 'notice', status: 'open', createdDate: daysAgo(8), assignedTo: 'Margaret Chen' },
    { id: 'VIO-0444', address: '928 Bray Ct', resident: 'Gregory Carter', community: 'Briarwood Oaks', type: 'Pet', description: 'Dog off-leash in common area - second offense', severity: 'warning', status: 'resolved', createdDate: daysAgo(15), assignedTo: 'Diana Reed', resolvedDate: daysAgo(13) },
    { id: 'VIO-0443', address: '696 Briarwood Village Pkwy', resident: 'Heather Nelson', community: 'Briarwood Oaks', type: 'Holiday Decorations', description: 'Holiday decorations not removed within 15-day post-holiday window', severity: 'notice', status: 'resolved', createdDate: daysAgo(30), assignedTo: 'Diana Reed', resolvedDate: daysAgo(25) }
  ];
  ...
  // ============================================
  var events = [
    { id: 'EVT-001', title: 'Board Meeting', community: 'Willowbrook', location: 'Heatherwood Clubhouse', date: daysFromNow(3), time: '7:00 PM', type: 'board', description: 'Quarterly board meeting - budget review and community updates' },
    ...
    { id: 'EVT-004', title: 'Budget Review', community: 'The Vineyards', location: 'Innisfree Community Center', date: daysFromNow(10), time: '6:00 PM', type: 'board', description: 'Mid-year budget review with financial committee' },
  ...
  // ============================================
  var activityFeed = [
    { id: 'ACT-001', type: 'work-order', icon: 'wrench', text: 'Margaret Chen created work order WO-1243', detail: 'Pool gate latch - The Bray', time: hoursAgo(4), color: 'navy' },
  ...
  // ============================================
  var auditLog = [
    { id: 'AUD-3421', timestamp: hoursAgo(0.5), actor: 'Margaret Chen', role: 'Community Director', action: 'Approved ARC request', target: 'ARC-2026-031 (Bennett)', severity: 'info' },
