...
(function() {
  ...
  // ============================================
  var communities = [
    { id: 'the-bray', name: 'The Bray', location: 'Liberty Park, Vestavia Hills', homes: 62, healthGrade: 'A', healthScore: 94, collectionRate: 97.2, activeIssues: 2, manager: 'Jennifer Walsh', boardPresident: 'Robert Caldwell', assessment: 275, established: 2004, reserveFund: 185000, annualBudget: 204600 },
    { id: 'heatherwood', name: 'Heatherwood', location: 'Liberty Park, Vestavia Hills', homes: 48, healthGrade: 'A-', healthScore: 91, collectionRate: 95.8, activeIssues: 1, manager: 'Jennifer Walsh', boardPresident: 'Linda Morris', assessment: 250, established: 2006, reserveFund: 142000, annualBudget: 144000 },
    { id: 'the-highlands', name: 'The Highlands', location: 'Liberty Park, Vestavia Hills', homes: 38, healthGrade: 'B+', healthScore: 86, collectionRate: 92.1, activeIssues: 3, manager: 'Sarah Chen', boardPresident: 'Mark Thornton', assessment: 300, established: 2001, reserveFund: 168000, annualBudget: 136800 },
    { id: 'innisfree', name: 'Innisfree', location: 'Liberty Park, Vestavia Hills', homes: 55, healthGrade: 'B+', healthScore: 87, collectionRate: 93.6, activeIssues: 2, manager: 'Sarah Chen', boardPresident: 'Patricia Hayes', assessment: 250, established: 2008, reserveFund: 128000, annualBudget: 165000 },
    { id: 'oak-grove', name: 'Oak Grove', location: 'Liberty Park, Vestavia Hills', homes: 44, healthGrade: 'A', healthScore: 95, collectionRate: 98.1, activeIssues: 0, manager: 'Jennifer Walsh', boardPresident: 'James Elliott', assessment: 350, established: 2003, reserveFund: 224000, annualBudget: 184800 },
    { id: 'the-gardens', name: 'The Gardens', location: 'Liberty Park, Vestavia Hills', homes: 52, healthGrade: 'B', healthScore: 82, collectionRate: 89.4, activeIssues: 4, manager: 'Sarah Chen', boardPresident: 'Donna Mitchell', assessment: 225, established: 2010, reserveFund: 98000, annualBudget: 140400 },
    { id: 'magnolia-place', name: 'Magnolia Place', location: 'Liberty Park, Vestavia Hills', homes: 35, healthGrade: 'A-', healthScore: 92, collectionRate: 96.5, activeIssues: 1, manager: 'Jennifer Walsh', boardPresident: 'William Foster', assessment: 275, established: 2005, reserveFund: 145000, annualBudget: 115500 },
    { id: 'the-reserve', name: 'The Reserve', location: 'Liberty Park, Vestavia Hills', homes: 41, healthGrade: 'B+', healthScore: 85, collectionRate: 91.7, activeIssues: 2, manager: 'Sarah Chen', boardPresident: 'Angela Brooks', assessment: 250, established: 2009, reserveFund: 112000, annualBudget: 123000 },
    { id: 'heritage-hills', name: 'Heritage Hills', location: 'Liberty Park, Vestavia Hills', homes: 58, healthGrade: 'A', healthScore: 93, collectionRate: 96.8, activeIssues: 1, manager: 'Jennifer Walsh', boardPresident: 'Thomas Graham', assessment: 300, established: 2002, reserveFund: 210000, annualBudget: 208800 },
    { id: 'summit-cove', name: 'Summit Cove', location: 'Liberty Park, Vestavia Hills', homes: 30, healthGrade: 'B', healthScore: 81, collectionRate: 88.3, activeIssues: 3, manager: 'Sarah Chen', boardPresident: 'Karen Price', assessment: 275, established: 2011, reserveFund: 78000, annualBudget: 99000 },
    { id: 'park-overlook', name: 'Park Overlook', location: 'Liberty Park, Vestavia Hills', homes: 24, healthGrade: 'C+', healthScore: 76, collectionRate: 84.2, activeIssues: 5, manager: 'Sarah Chen', boardPresident: 'Steven Clark', assessment: 225, established: 2013, reserveFund: 52000, annualBudget: 64800 },
    { id: 'liberty-ridge', name: 'Liberty Ridge', location: 'Liberty Park, Vestavia Hills', homes: 210, healthGrade: 'A-', healthScore: 90, collectionRate: 95.1, activeIssues: 4, manager: 'Jennifer Walsh', boardPresident: 'David Lawson', assessment: 275, established: 2000, reserveFund: 520000, annualBudget: 693000 },
    { id: 'cahaba-ridge', name: 'Cahaba Ridge', location: 'Liberty Park, Vestavia Hills', homes: 180, healthGrade: 'A', healthScore: 93, collectionRate: 97.4, activeIssues: 2, manager: 'Jennifer Walsh', boardPresident: 'Catherine Moore', assessment: 325, established: 1998, reserveFund: 480000, annualBudget: 702000 },
    { id: 'preserve-at-liberty', name: 'Preserve at Liberty', location: 'Liberty Park, Vestavia Hills', homes: 350, healthGrade: 'B+', healthScore: 88, collectionRate: 94.3, activeIssues: 6, manager: 'Sarah Chen', boardPresident: 'Richard Barnes', assessment: 250, established: 1999, reserveFund: 680000, annualBudget: 1050000 },
    { id: 'liberty-park-village', name: 'Liberty Park Village', location: 'Liberty Park, Vestavia Hills', homes: 320, healthGrade: 'A-', healthScore: 91, collectionRate: 96.0, activeIssues: 3, manager: 'Jennifer Walsh', boardPresident: 'Elizabeth Ward', assessment: 275, established: 2001, reserveFund: 620000, annualBudget: 1056000 }
  ];
  ...
  var residents = [
    ...
    { id: 'R-003', firstName: 'James', lastName: 'Cooper', initials: 'JC', email: 'james.cooper@email.com', phone: '(205) 555-0387', address: '387 Innisfree Cir', community: 'innisfree', communityName: 'Innisfree', status: 'past-due', balance: 550.00, lastPayment: daysAgo(45), moveInDate: '2017-11-22', avatarColor: 'gold' },
    { id: 'R-004', firstName: 'Amanda', lastName: 'Price', initials: 'AP', email: 'amanda.price@email.com', phone: '(205) 555-0156', address: '156 Summit Cove Ln', community: 'summit-cove', communityName: 'Summit Cove', status: 'current', balance: 0, lastPayment: daysAgo(8), moveInDate: '2021-08-01', avatarColor: 'teal' },
    { id: 'R-005', firstName: 'Nathan', lastName: 'Brooks', initials: 'NB', email: 'nathan.brooks@email.com', phone: '(205) 555-0293', address: '293 Park Overlook Dr', community: 'park-overlook', communityName: 'Park Overlook', status: 'delinquent', balance: 825.00, lastPayment: daysAgo(95), moveInDate: '2018-04-15', avatarColor: 'navy' },
    { id: 'R-006', firstName: 'Jennifer', lastName: 'Murphy', initials: 'JM', email: 'jennifer.murphy@email.com', phone: '(205) 555-0744', address: '744 Oak Grove Ct', community: 'oak-grove', communityName: 'Oak Grove', status: 'current', balance: 0, lastPayment: daysAgo(3), moveInDate: '2016-09-30', avatarColor: 'gold' },
    { id: 'R-007', firstName: 'David', lastName: 'Chen', initials: 'DC', email: 'david.chen@email.com', phone: '(205) 555-0518', address: '518 Heatherwood Blvd', community: 'heatherwood', communityName: 'Heatherwood', status: 'current', balance: 250.00, lastPayment: daysAgo(20), moveInDate: '2019-01-12', avatarColor: 'teal' },
    ...
    { id: 'R-011', firstName: 'Robert', lastName: 'Martinez', initials: 'RM', email: 'robert.martinez@email.com', phone: '(205) 555-0912', address: '912 The Reserve Rd', community: 'the-reserve', communityName: 'The Reserve', status: 'current', balance: 250.00, lastPayment: daysAgo(18), moveInDate: '2017-05-10', avatarColor: 'navy' },
    ...
    { id: 'R-013', firstName: 'Thomas', lastName: 'Wilson', initials: 'TW', email: 'thomas.wilson@email.com', phone: '(205) 555-0188', address: '188 Cahaba Ridge Ct', community: 'cahaba-ridge', communityName: 'Cahaba Ridge', status: 'current', balance: 325.00, lastPayment: daysAgo(14), moveInDate: '2019-09-22', avatarColor: 'teal' },
    { id: 'R-014', firstName: 'Maria', lastName: 'Garcia', initials: 'MG', email: 'maria.garcia@email.com', phone: '(205) 555-0347', address: '347 Cahaba Reserve Way', community: 'preserve-at-liberty', communityName: 'Preserve at Liberty', status: 'current', balance: 0, lastPayment: daysAgo(4), moveInDate: '2020-06-14', avatarColor: 'navy' },
    { id: 'R-015', firstName: 'Daniel', lastName: 'Thompson', initials: 'DT', email: 'daniel.thompson@email.com', phone: '(205) 555-0556', address: '556 Liberty Park Village Pkwy', community: 'liberty-park-village', communityName: 'Liberty Park Village', status: 'delinquent', balance: 1100.00, lastPayment: daysAgo(120), moveInDate: '2016-02-28', avatarColor: 'gold' },
    ...
    { id: 'R-017', firstName: 'Kevin', lastName: 'Davis', initials: 'KD', email: 'kevin.davis@email.com', phone: '(205) 555-0894', address: '894 Heatherwood Blvd', community: 'heatherwood', communityName: 'Heatherwood', status: 'current', balance: 250.00, lastPayment: daysAgo(22), moveInDate: '2018-10-05', avatarColor: 'navy' },
    ...
    { id: 'R-019', firstName: 'Andrew', lastName: 'Jackson', initials: 'AJ', email: 'andrew.jackson@email.com', phone: '(205) 555-0467', address: '467 Oak Grove Ct', community: 'oak-grove', communityName: 'Oak Grove', status: 'current', balance: 350.00, lastPayment: daysAgo(16), moveInDate: '2017-07-12', avatarColor: 'teal' },
    { id: 'R-020', firstName: 'Stephanie', lastName: 'White', initials: 'SW2', email: 'stephanie.white@email.com', phone: '(205) 555-0683', address: '683 Innisfree Cir', community: 'innisfree', communityName: 'Innisfree', status: 'current', balance: 0, lastPayment: daysAgo(10), moveInDate: '2021-11-30', avatarColor: 'navy' },
    ...
    { id: 'R-022', firstName: 'Nicole', lastName: 'Lewis', initials: 'NL', email: 'nicole.lewis@email.com', phone: '(205) 555-0941', address: '941 Cahaba Ridge Ct', community: 'cahaba-ridge', communityName: 'Cahaba Ridge', status: 'current', balance: 0, lastPayment: daysAgo(3), moveInDate: '2022-05-17', avatarColor: 'teal' },
    { id: 'R-023', firstName: 'Mark', lastName: 'Robinson', initials: 'MR', email: 'mark.robinson@email.com', phone: '(205) 555-0378', address: '378 Cahaba Reserve Way', community: 'preserve-at-liberty', communityName: 'Preserve at Liberty', status: 'current', balance: 250.00, lastPayment: daysAgo(19), moveInDate: '2016-08-25', avatarColor: 'navy' },
    { id: 'R-024', firstName: 'Kimberly', lastName: 'Clark', initials: 'KC', email: 'kim.clark@email.com', phone: '(205) 555-0612', address: '612 Liberty Park Village Pkwy', community: 'liberty-park-village', communityName: 'Liberty Park Village', status: 'current', balance: 0, lastPayment: daysAgo(7), moveInDate: '2020-09-14', avatarColor: 'gold' },
    ...
    { id: 'R-027', firstName: 'Ryan', lastName: 'Allen', initials: 'RA', email: 'ryan.allen@email.com', phone: '(205) 555-0534', address: '534 Summit Cove Ln', community: 'summit-cove', communityName: 'Summit Cove', status: 'current', balance: 0, lastPayment: daysAgo(6), moveInDate: '2021-06-10', avatarColor: 'gold' },
    { id: 'R-028', firstName: 'Lisa', lastName: 'Young', initials: 'LY', email: 'lisa.young@email.com', phone: '(205) 555-0793', address: '793 Park Overlook Dr', community: 'park-overlook', communityName: 'Park Overlook', status: 'past-due', balance: 450.00, lastPayment: daysAgo(48), moveInDate: '2019-11-18', avatarColor: 'teal' },
    ...
    { id: 'R-030', firstName: 'Rebecca', lastName: 'Wright', initials: 'RW', email: 'rebecca.wright@email.com', phone: '(205) 555-0629', address: '629 The Reserve Rd', community: 'the-reserve', communityName: 'The Reserve', status: 'current', balance: 0, lastPayment: daysAgo(4), moveInDate: '2022-07-20', avatarColor: 'gold' },
    ...
    { id: 'R-032', firstName: 'Angela', lastName: 'Green', initials: 'AG', email: 'angela.green@email.com', phone: '(205) 555-0815', address: '815 Cahaba Ridge Ct', community: 'cahaba-ridge', communityName: 'Cahaba Ridge', status: 'current', balance: 325.00, lastPayment: daysAgo(17), moveInDate: '2019-05-30', avatarColor: 'navy' },
    { id: 'R-033', firstName: 'Eric', lastName: 'Adams', initials: 'EA', email: 'eric.adams@email.com', phone: '(205) 555-0153', address: '153 Cahaba Reserve Way', community: 'preserve-at-liberty', communityName: 'Preserve at Liberty', status: 'current', balance: 0, lastPayment: daysAgo(5), moveInDate: '2021-01-08', avatarColor: 'gold' },
    { id: 'R-034', firstName: 'Heather', lastName: 'Nelson', initials: 'HN', email: 'heather.nelson@email.com', phone: '(205) 555-0696', address: '696 Liberty Park Village Pkwy', community: 'liberty-park-village', communityName: 'Liberty Park Village', status: 'current', balance: 275.00, lastPayment: daysAgo(11), moveInDate: '2018-06-25', avatarColor: 'teal' },
  ...
  var workOrders = [
    ...
    { id: 'WO-1246', community: 'innisfree', communityName: 'Innisfree', title: 'Fence section down after storm', description: 'Section of community fence along Innisfree Cir collapsed during last week\'s storm. Approximately 20ft section.', category: 'Fencing', priority: 'high', status: 'assigned', assignedTo: 'Regional Fence Co.', estimatedCost: 2800, createdDate: daysAgo(2), updatedDate: daysAgo(1), reportedBy: 'Jennifer Walsh', timeline: [{ date: daysAgo(2), action: 'Created', actor: 'Jennifer Walsh', note: 'Storm damage reported by multiple residents' }, { date: daysAgo(1), action: 'Assigned', actor: 'Sarah Chen', note: 'Vendor Regional Fence Co. notified, estimate requested' }] },
    { id: 'WO-1245', community: 'park-overlook', communityName: 'Park Overlook', title: 'Playground equipment inspection needed', description: 'Annual safety inspection for community playground equipment is due. Swing set chains showing wear.', category: 'Inspection', priority: 'high', status: 'pending', assignedTo: 'Unassigned', estimatedCost: 350, createdDate: daysAgo(1), updatedDate: daysAgo(1), reportedBy: 'Sarah Chen', timeline: [{ date: daysAgo(1), action: 'Created', actor: 'Sarah Chen', note: 'Annual inspection overdue, swing chains flagged' }] },
    { id: 'WO-1244', community: 'oak-grove', communityName: 'Oak Grove', title: 'Irrigation system leak - common area', description: 'Irrigation head leaking near the community entrance garden. Causing muddy area near walkway.', category: 'Landscaping', priority: 'medium', status: 'in-progress', assignedTo: 'GreenScape LLC', estimatedCost: 600, createdDate: daysAgo(5), updatedDate: daysAgo(1), reportedBy: 'Jennifer Murphy', timeline: [{ date: daysAgo(5), action: 'Created', actor: 'Jennifer Murphy', note: 'Reported via member portal' }, { date: daysAgo(4), action: 'Assigned', actor: 'Jennifer Walsh', note: 'Sent to GreenScape for assessment' }, { date: daysAgo(1), action: 'Updated', actor: 'GreenScape LLC', note: 'Parts ordered, repair scheduled for next week' }] },
  ...
  var arcApplications = [
    ...
    { id: 'ARC-2026-030', resident: 'Thomas Wilson', community: 'Cahaba Ridge', address: '188 Cahaba Ridge Ct', type: 'Deck Expansion', description: 'Extend existing deck by 8 feet with composite decking', status: 'approved', submittedDate: daysAgo(12), estimatedCost: 12000, attachments: 4, approvedDate: daysAgo(5) },
    ...
    { id: 'ARC-2026-024', resident: 'Mark Robinson', community: 'Preserve at Liberty', address: '378 Cahaba Reserve Way', type: 'Solar Panels', description: 'Roof-mounted solar panel installation, 24 panels', status: 'under-review', submittedDate: daysAgo(2), estimatedCost: 28000, attachments: 5 }
  ];
  ...
  // ============================================
  var violations = [
    { id: 'VIO-0452', address: '293 Park Overlook Dr', resident: 'Nathan Brooks', community: 'Park Overlook', type: 'Yard Maintenance', description: 'Grass exceeding 8-inch maximum height', severity: 'warning', status: 'open', createdDate: daysAgo(2), assignedTo: 'Sarah Chen' },
    ...
    { id: 'VIO-0448', address: '683 Innisfree Cir', resident: 'Stephanie White', community: 'Innisfree', type: 'Trash/Debris', description: 'Trash cans left at curb past 24-hour removal deadline', severity: 'warning', status: 'resolved', createdDate: daysAgo(10), assignedTo: 'Sarah Chen', resolvedDate: daysAgo(7) },
    { id: 'VIO-0447', address: '534 Summit Cove Ln', resident: 'Ryan Allen', community: 'Summit Cove', type: 'Parking', description: 'Commercial vehicle parked overnight in residential area', severity: 'notice', status: 'open', createdDate: daysAgo(3), assignedTo: 'Sarah Chen' },
    { id: 'VIO-0446', address: '941 Cahaba Ridge Ct', resident: 'Nicole Lewis', community: 'Cahaba Ridge', type: 'Noise', description: 'Repeated noise complaints from neighbors regarding late-night construction', severity: 'warning', status: 'resolved', createdDate: daysAgo(20), assignedTo: 'Jennifer Walsh', resolvedDate: daysAgo(12) },
    { id: 'VIO-0445', address: '387 Innisfree Cir', resident: 'James Cooper', community: 'Innisfree', type: 'Unapproved Modification', description: 'Storage shed installed without ARC approval', severity: 'notice', status: 'open', createdDate: daysAgo(8), assignedTo: 'Jennifer Walsh' },
    ...
    { id: 'VIO-0443', address: '696 Liberty Park Village Pkwy', resident: 'Heather Nelson', community: 'Liberty Park Village', type: 'Holiday Decorations', description: 'Holiday decorations not removed within 15-day post-holiday window', severity: 'notice', status: 'resolved', createdDate: daysAgo(30), assignedTo: 'Sarah Chen', resolvedDate: daysAgo(25) }
  ];
  ...
  // ============================================
  var events = [
    { id: 'EVT-001', title: 'Board Meeting', community: 'Heatherwood', location: 'Heatherwood Clubhouse', date: daysFromNow(3), time: '7:00 PM', type: 'board', description: 'Quarterly board meeting - budget review and community updates' },
    { id: 'EVT-002', title: 'Annual Inspection', community: 'Oak Grove', location: 'Common Areas', date: daysFromNow(5), time: '9:00 AM', type: 'inspection', description: 'Annual property and common area inspection walk-through' },
    ...
    { id: 'EVT-004', title: 'Budget Review', community: 'Innisfree', location: 'Innisfree Community Center', date: daysFromNow(10), time: '6:00 PM', type: 'board', description: 'Mid-year budget review with financial committee' },
    ...
    { id: 'EVT-007', title: 'Clubhouse Rental', community: 'Summit Cove', location: 'Summit Cove Clubhouse', date: daysFromNow(6), time: '2:00 PM', type: 'reservation', description: 'Private event reservation - Thompson family' },
    ...
    { id: 'EVT-009', title: 'Tree Removal', community: 'Heatherwood', location: 'Common Area', date: daysFromNow(7), time: '8:00 AM', type: 'maintenance', description: 'Birmingham Tree Service - dead oak removal (WO-1238)' },
    { id: 'EVT-010', title: 'Board Meeting', community: 'Liberty Park Village', location: 'Liberty Park Village Clubhouse', date: daysFromNow(12), time: '6:30 PM', type: 'board', description: 'Monthly board meeting - new business and resident concerns' }
  ];
  ...
  var activityFeed = [
    ...
    { id: 'ACT-003', type: 'arc', icon: 'clipboard', text: 'ARC application submitted', detail: 'ARC-2026-024 — Solar panels, Preserve at Liberty', time: hoursAgo(8), color: 'gold' },
    { id: 'ACT-004', type: 'violation', icon: 'alert', text: 'Violation notice issued', detail: 'VIO-0452 — Yard maintenance, Park Overlook', time: hoursAgo(12), color: 'danger' },
    ...
    { id: 'ACT-007', type: 'document', icon: 'file', text: 'Board minutes uploaded', detail: 'Heatherwood — March 2026 meeting minutes', time: daysAgo(1), color: 'navy' },
    ...
    { id: 'ACT-011', type: 'violation', icon: 'alert', text: 'Violation VIO-0448 resolved', detail: 'Trash/debris — Innisfree', time: daysAgo(3), color: 'teal' },
